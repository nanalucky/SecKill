...
SetupOCXFile=
[Comment]
�޸��ֻ�ʱ�䵽����ʱ��󣬵����ʼ���ң������ӱ���Ϊsaz����ѹ����1_c,2_c���ļ��ֱ𿽱���Զ��vps��һ̨��Ӧһ���ļ������ļ�����Ϊ1.txt,ʶ������948kb��
...
Function UpdateCookieCaptcha(responseHeader)
	...
	End If
End Function
n = Lib.�ļ�.����ָ��Ŀ¼�������ļ���("C:\Users\Administrator\Desktop")
...
Do
	...
	If isEmpty(http.responsetext) Then 
		TracePrint "findSectionGoodsDetailInfo ʧ�ܣ����·���"
	Else 
		...
		If errorCode <> "0" Then
			...
			TracePrint "findSectionGoodsDetailInfo (" & errorMsg & ")�����·���"
		Else
			Exit Do
		End If
	End If
...
Do
	...
	If isEmpty(http.responsetext) Then 
		TracePrint "prepareSeckill ʧ�ܣ����·���"
	Else 
		response = http.responsetext
		errorCode = GetStrAB(response, "<errorCode>", "</errorCode>")
		If errorCode <> "0" Then
			errorMsg = GetStrAB(response, "<errorMsg>", "</errorMsg>")
 			TracePrint "prepareSeckill (" & errorMsg & ")�����·���"
		Else
			app = paramAppId
			userId = paramUserId
...
If result <> "success" Then
	TracePrint "newcaptcha result(" &result& ")�����·���"
	Goto subcaptcha
End If
...
if isEmpty(http.ResponseBody) Then
	TracePrint "downloadCaptchaImage ʧ�ܣ����·���"
	Goto subcaptcha
End If
...
If result <> "success" Then
	TracePrint "verifyCaptcha result(" & result & ")�����·���"
	Goto subcaptcha
End If
